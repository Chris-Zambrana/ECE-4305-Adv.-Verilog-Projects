...
void BlinkingLedCore::write_rate(int register_num, uint32_t data) {
   wr_data = data;
   io_write(base_addr, register_num, wr_data);
}

/*
int BlinkingLedCore::read_rate(int register_num) {
   return (io_read(base_addr, register_num));
}
*/