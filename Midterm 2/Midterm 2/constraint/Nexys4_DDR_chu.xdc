...
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports {tmp_i2c_scl}]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports {tmp_i2c_sda}]
