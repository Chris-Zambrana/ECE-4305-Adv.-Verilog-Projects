...
(
   ...
   // signal declaration
   // video data stream
   logic [CD-1:0] frame_rgb8, radar_rgb7, gray_rgb6, user5_rgb5;         
   ...
   chu_vga_radar_core v7_radar_unit (
      .clk(clk_sys),
      .reset(reset_sys),
      .x(x),
      .y(y),
      .cs(slot_cs_array[`V7_RADAR]),
      .write(slot_mem_wr_array[`V7_RADAR]),
      .addr(slot_reg_addr_array[`V7_RADAR]),
      .wr_data(slot_wr_data_array[`V7_RADAR]),
      .si_rgb(frame_rgb8),
      .so_rgb(radar_rgb7)
   );
